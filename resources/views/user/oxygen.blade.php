...
<h1>OXYGEN LIST</h1>
  ...
  <div class="row">
    ...
    <img style="height:80px;width:95px;" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJsfoakEAjAolvmonYjrpzX954IB_vYq4TWw&usqp=CAU" alt="">
      <p><b>Name:{{$oxy->name}}</b></p>
      <p><b>Types:{{$oxy->types}}</b></p>
      <p><b>Address:{{$oxy->address}}</b></p>
