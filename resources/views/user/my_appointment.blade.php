...
<body>
  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="/home"><span class="text-primary">Covid Treatment</span> System</a>
...
<div  align="center" style="padding:70px;">
    <table>
        ...
        <tr style="background-color:black;" align="center">
            ...
            <td style="padding:10px;font-size: 20px;color:white">{{$appointments->doctor}}</td>
