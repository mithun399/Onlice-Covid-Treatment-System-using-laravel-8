...
<body>
  ...
  <div class="page-section">
    <div class="container">
      <h1 class="text-center mb-5 wow fadeInUp">Patients</h1>
      ...
      <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img src="patient/{{$patients->image}}" alt="">
              <div class="meta">
            ...
            <div class="body">
              <p class="text-xl mb-0">{{$patients->name}}</p>
              <span class="text-sm text-grey">Blood Group:{{$patients->blood}}</span>
            </div>
          </div>
        </div>
@endforeach
